...
::: { .callout-warning title="But this was for an infinite number of measurements of $z$" }
:::

::: { .callout-important }
We cannot make an infinite number of measurements of $z$. We can only _take a **sample**_.

The variance we _estimate_ in an experiment **will not match** that of the infinitely large population[^bias].
:::

[^bias]: The variance we calculate for our small experimental sample uses an estimate of the mean also calculated from the sample, and so is biased.

## (Unbiased) sample variance

::: { .callout-note title="We do not know the true population-level variance" }
