...
- E.g., an estimate may be considered "statistically significant at $P < 0.05$" if it:
  - lies at least two standard errors[^1] from the mean
...
[^1]: Remember the probability mass of the normal distribution?
...
- Two drugs, $C$ and $T$ lower cholesterol[^1], and we want to compare their effectiveness
...
[^1]: $C$ for _control_, the current best-in class; $T$ for _treatment_, the new compound
